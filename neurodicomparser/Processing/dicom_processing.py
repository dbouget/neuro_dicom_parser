...
def unpack_convert_dicom_folder(input_folder: str, output_folder: str = None, method: str = 'dcm2niix') -> None:
    """
    ...
    # Skipping patients where the conversion has already been done -- for now?
    if os.path.exists(output_root):
        logging.info("Skipping DICOM to nifti conversion, output folder already exists!")
        return
